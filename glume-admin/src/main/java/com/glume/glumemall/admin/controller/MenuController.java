...
public class MenuController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "path",value = "菜单地址",dataType = "String"),
            @ApiImplicitParam(name = "component",value = "菜单路径",dataType = "String"),
            ...
            @ApiImplicitParam(name = "icon",value = "菜单图标",dataType = "String"),
