...
public class JobInvokeUtil {
    /**
     * 执行方法
     * @param scheduleJobEntity 系统任务
     */
    public static void invokeMethod(ScheduleJobEntity scheduleJobEntity) throws Exception {
        String invokeTarget = scheduleJobEntity.getInvokeTarget();
