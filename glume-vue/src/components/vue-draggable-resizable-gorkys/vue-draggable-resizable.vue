<template>
  <div :style="style"
    ...
    <div v-for="handle in actualHandles"
      ...
      <slot v-if="handle == 'tl'" name="tl"></slot>
      <slot v-else-if="handle == 'tm'" name="tm"></slot>
      <slot v-else-if="handle == 'tr'" name="tr"></slot>
      <slot v-else-if="handle == 'mr'" name="mr"></slot>
      <slot v-else-if="handle == 'br'" name="br"></slot>
      <slot v-else-if="handle == 'bm'" name="bm"></slot>
      <slot v-else-if="handle == 'bl'" name="bl"></slot>
      <slot v-else-if="handle == 'ml'" name="ml"></slot>
    </div>
    <slot></slot>
  </div>
</template>
