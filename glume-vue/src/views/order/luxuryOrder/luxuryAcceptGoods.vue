<template>
  <layout-container>
    ...
    <el-card class="box-card min-h8">
      ...
      <!--    内容展示-->
      <table-box :loading="loading" :data="orderData" :tableColumn="tableColumn" @finish="finish" @jumpPage="jumpPage" @selection-change="handleSelectionChange"/>
    ...
    data() {
      return {
        tableColumn: [
          ...
          {label: '预估价',prop: 'evaluate_price'},
          {label: '成交价',prop: 'end_price'},
          ...
          {label: '操作',size: 'mini',model: [{name: '确认完成',color: 'success',onClick: 'finish'},
