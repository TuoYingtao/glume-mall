<template>
  <layout-container>
    ...
    <el-card class="box-card min-h8">
      ...
      <!--    内容展示-->
      <table-box :loading="loading" :data="orderData" :tableColumn="tableColumn" @affirm="affirm" @selection-change="handleSelectionChange"/>
    ...
    data() {
      return {
        tableColumn: [
          ...
          {label: '操作',size: 'mini', model: [{name: '确认完成',color: 'success',onClick: 'affirm'}],type: 'bottom'},
        ],
        total: 0,
        showSearch: true,
        loading: false,
